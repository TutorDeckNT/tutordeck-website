    ...
    <main className="min-h-screen flex items-center justify-center bg-dark-bg bg-dot-pattern">
      <Reveal className="container mx-auto px-6 text-center">
        <div className="bg-dark-card max-w-md mx-auto p-8 md:p-12 rounded-2xl shadow-2xl border border-gray-700">
          <img src="/mascot.svg" alt="TutorDeck Mascot" className="h-24 w-24 rounded-no object-cover mx-auto mb-6" />
          ...
          <button 
            ...
            className="w-full cta-button bg-white text-gray-800 font-semibold py-3 px-6 rounded-lg flex items-center justify-center gap-4 hover:bg-gray-200 transition-colors"
          >
