...
import EventModal from '../components/EventModal'; // Import the new modal
...
const HomePage = () => {
    ...
    return (
        <>
            ...
            <main>
                <section id="hero" className="flex items-center justify-center text-center relative overflow-hidden" style={{ minHeight: '80vh' }}>
                    ...
                    <Reveal className="container mx-auto px-6 relative z-10">
                        ...
                        {/* HERO CONTENT */}
                        <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-200 to-primary-light mb-4 py-2">
