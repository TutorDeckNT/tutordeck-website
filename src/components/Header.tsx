...
const VerticalDivider = () => <div className="h-6 w-px bg-white/20 flex-shrink-0" />;
                                ...
                                <div className="relative" ref={dropdownRef}>
                                    ...
                                    {isDropdownOpen && (
                                        <div className="absolute right-0 mt-4 z-50 w-64 origin-top-right bg-gray-200/10 backdrop-blur-xl rounded-2xl border border-white/20 shadow-xl">
                                            ...
                                            <ul className="py-2"><li onClick={closeMobileMenu}><a href="#" onClick={handleLogout} className="flex items-center gap-3 px-4 py-2 text-sm text-gray-200 hover:bg-white/10"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M12 9l-3 3m0 0 3 3m-3-3h12.75" /></svg><span>Sign out</span></a></li></ul>
                                        </div>
                                    )}
                                </div>
                            ) : (
