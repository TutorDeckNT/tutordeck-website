...
const Header = () => {
    ...
    return (
        <header className="fixed top-4 left-1/2 z-50 -translate-x-1/2">
            {/* This inner div now controls the animated size and appearance */}
            <div
                className={`
                    w-full bg-gray-900/40 backdrop-blur-xl rounded-full border border-white/20 shadow-xl
                    transition-[max-width] duration-500 ease-in-out
                    ${user ? 'max-w-3xl' : 'max-w-xl'}
                `}
            >
